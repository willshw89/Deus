//=============================================================================
// UF_Camera.js - Zoom the map view out and in, in pixel-exact steps
//=============================================================================

/*:
 * @target MZ
 * @plugindesc [UF Camera] Zoom the map view out/in (mouse wheel, - and + keys) in pixel-exact steps.
 * @author UF project
...
(() => {
    ...
    const P = PluginManager.parameters("UF_Camera");
    const parseLevel = s => {
