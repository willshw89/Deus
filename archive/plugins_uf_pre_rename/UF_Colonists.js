...
(() => {
    ...
    function registerChecks() {
        UF.Test.suite("colonists", async t => {
            ...
            const first = units[0];
            t.check("player_faction", first && (first.data.faction === "player" || (UF.Factions && UF.Factions.playerFactionId && first.data.faction === UF.Factions.playerFactionId())), `player faction ${first ? first.data.faction : 'none'}`);
