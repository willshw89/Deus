//=============================================================================
// DEUS_Time.js - Multi-Domain Time Architecture
// Engine Ticks, Tactical Action Time, Historical Simulation & Presentation Clock
//=============================================================================

/*:
 * @target MZ
 * @plugindesc [DEUS Time] Authoritative multi-domain time architecture: Engine Ticks (20 Hz computation), Tactical Action Clock (6s d20 rounds), Historical Clock (1s = 2h biological aging), and Presentation Clock (60m solar cycle).
 * @author UF project
 * @base DEUS_World
