...
/*:
 * @target MZ
 * @plugindesc [DEUS Dialogue] Classic Ultima VII keyword conversation trees with character portraits, tactile mouse selection, and dynamic party recruitment.
...
(() => {
    ...
    const pluginName = "DEUS_Dialogue";
