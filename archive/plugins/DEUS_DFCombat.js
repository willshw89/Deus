...
/*:
 * @target MZ
 * @plugindesc [DEUS DFCombat] Multi-Racial Dwarf Fortress anatomical wound simulation (body parts, tissues, severed limbs/wings/horns/tails/servos, arterial bleeding, plasma burns, arc shock, and authentic DF announcements).
...
(() => {
    ...
    const pluginName = "DEUS_DFCombat";
    window.UF_DFCombat = {};
