...
/*:
 * @target MZ
 * @plugindesc [DEUS Crafting] Dwarf Fortress workshop reactions (Brewing, Smelting, Forging, Precursor Fabrication) and Strange Artisan Moods.
...
(() => {
    ...
    const pluginName = "DEUS_Crafting";
    window.UF_Crafting = {};
