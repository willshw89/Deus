/*:
 * @target MZ
 * @plugindesc [DEUS Goals] Persistent personal ambitions, physical work priorities, and a selected-creature goals panel (F7).
 * @author UF project
 * @base DEUS_World
 * @orderAfter DEUS_Colonists
 * @orderAfter DEUS_Skills
 * @orderAfter DEUS_Households
 * @orderAfter DEUS_CultureGrowth
 * @help
