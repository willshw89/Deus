...
- **Conservation Consequence**: Finite materials begin almost entirely in their native geological strata ($N_{\text{deposits}}$). Only the initial starter tools and equipment for the 72 founders exist as manufactured items, debited directly from the world total.
