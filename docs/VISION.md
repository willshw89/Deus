...
| V49 | **Every living creature has a character sheet:** a grid inventory (U7-style), equipment slots (helmet, weapon, shield, torso, legs), a portrait from a U7-style face set, and a behaviors page (labors on/off, combat mode, how it treats strangers, schedule). Opened from the unit (Info) for your own people; strangers show what you can see. |
