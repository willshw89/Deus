...
| **INV-SOC-09** | **Canonical 2014 SRD Class Source** | All Class mechanics, spell progressions, proficiencies, and combat capabilities derive exclusively from the 2014 SRD 5.1 (CC-BY-4.0) specification (local untracked reference copy). | `SOC.11.01`, `docs/SRD5_1_INTEGRATION.md` |
