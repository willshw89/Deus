...
3. **One Authoritative World:** Worldgen owns initial Year-0 conditions; Live Simulation owns post-Year-0 changes. Both operate on the **exact same single source of truth** (the five-strata physical world model, `DEUS_Levels.js`, `DEUS_Fluid.js`, `DEUS_World.js`). There is never a duplicate "generated world" vs "simulation world."
