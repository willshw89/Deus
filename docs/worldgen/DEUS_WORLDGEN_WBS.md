...
| **WG.62.02** | Race Home-Layer Assignment in WorldGen | Fable | Procedural spawn placement and native habitat generation for 9 races across 32 Z layers (-16..+15) and 5 vertical biome bands (Deep Earth -16..-11, Caverns -10..-5, Lowlands -4..+1, Uplands +2..+6, Highlands +7..+11). Soft home layer ranges with cross-layer travel/trade/war. Depends on WG.00.17 and race design doc. | `PLANNED` |
