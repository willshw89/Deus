...
| # | Rule |
|---|---|
| F1 | **Pure 2D Top-Down View (V131):** ground seen from directly above in standard 2D top-down RPG projection (FF5 style for humanoids at 48px, FF6 style for large monsters at 96px); people, animals, trees and objects stand upright in 2D space. Zero 2.5D axonometric elevation projection, zero fake screen offsets, and zero cast shadow sprites. |
