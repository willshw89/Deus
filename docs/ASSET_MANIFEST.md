...
| `obj_campfire` | `img/characters/!$UF_Campfire.png` | (0..2, 0..3) | Object | `woods:hardwood` / `stones:granite` | Animated | 1x1 | 0..2 | 150ms | (0.5, 1.0) | 0 | NO | `UF_Objects` / `UF_Fire` | v2.0 | YES |
