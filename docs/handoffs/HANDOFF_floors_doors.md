...
- Original art in the current V2 flat, high-definition FF6-style 3/4 view: crisp clusters, selective outlines, lively cel shading, readable at 1×, no oblique 2.5D lean, blur, or semi-transparent edge pixels. Generate the source exclusively with **Google Nano Banana Pro** (`generate_image`, model id `gemini-3-pro-image`, Gemini 3 Pro Image model; AGENTS.md Rule 11, VISION V69, V70, V79, V109) and pack it into the standard RMMZ sheet required by V69/V70. Nano Banana Pro utilizes advanced reasoning ("Thinking") to follow complex instructions, maintain brand consistency, and render high-fidelity text and pixel details.
