...
| AR-104 | Site pieces: wooden wall (palisade), stone wall, rubble, fallen pillar, old bones, straw bed, work stone, **stockpile marker** (a flat dashed square); each intact + ruined | History sites and ruins, colony building | High | REQUESTED (stock RMMZ tiles in use: `Outside_B` 80 wall_wood, 248 straw bed; `Outside_C` 277 stone wall, 282 rubble, 285 work stone, 286 fallen pillar; `!$U7_OldBones`, `!$U7_LooseStones`, `!$U7_Gravel` stand-ins; code-drawn `UF_GenStockpile`) |
