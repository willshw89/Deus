...
| AR-701 | Character-sheet UI: inventory grid cell frame, equipment slot frames (helmet, weapon, shield, torso, legs), page tabs, in the window skin's style | V49 | Medium | REQUESTED (drawn from the window skin until then) |
