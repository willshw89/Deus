...
| AR-501 | Clothing tiers for the pair: 1 woven wraps, 2 hides, 3 tailored, male and female, 4 facings × walk | V35 (the pair make clothes) | High | DELIVERED as stand-ins (`$U7_Adam_T1..T3`, `$U7_Eve_T1..T3`) |
