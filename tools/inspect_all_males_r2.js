...
for (let i = 0; i < maleFiles.length; i++) {
    ...
    for (let c = 0; c < 6; c++) {
        ...
        const frame = extractFrameFromCell(img, x0, x1, 2 * ch, 3 * ch, 43, 44);
...
writePNG('game/test_output/all_males_row2_north_cells.png', w, h, outBuf);
console.log('Saved game/test_output/all_males_row2_north_cells.png');
