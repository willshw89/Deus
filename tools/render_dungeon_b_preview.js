...
const p = path.join(__dirname, '..', 'game', 'img', 'tilesets', 'Dungeon_B.png');
const img = decodePNG(fs.readFileSync(p), 'dungeon_b');
const sw = 512, sh = 512;
...
const outPath = path.join(__dirname, '..', 'art', 'review', 'stock_dungeon_b_preview.png');
