...
const pngPath = 'C:/Users/snewt/.gemini/antigravity/brain/3ffbd16e-0b90-4fbe-9345-ac504edad4c5/wall_wood_2square.png';
const decoded = decodePNG(fs.readFileSync(pngPath), 'wall_wood_2square.png');
...
for (let y = 0; y < decoded.height; y++) {
    for (let x = 0; x < decoded.width; x++) {
        ...
        const isMagenta = (r > 150 && g < 100 && b > 150);
        if (!isMagenta) {
            if (x < minX) minX = x;
            if (x > maxX) maxX = x;
            if (y < minY) minY = y;
