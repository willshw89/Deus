...
for (let i = 0; i < femaleFiles.length; i++) {
    ...
    for (let c = 0; c < 6; c++) {
        ...
        const frame = extractFrameFromCell(img, x0, x1, 0, ch, 43, 44);
...
writePNG('game/test_output/all_females_row0_cells.png', w, h, outBuf);
console.log('Saved game/test_output/all_females_row0_cells.png');
