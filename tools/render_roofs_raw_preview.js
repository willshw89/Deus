...
const p = path.join(__dirname, '..', 'art', 'raw', 'roofs_nano_raw.png');
const img = decodePNG(fs.readFileSync(p), 'roofs');
const sw = 512, sh = 512;
...
const outPath = path.join(__dirname, '..', 'art', 'review', 'raw_inspect_roofs_nano_raw.png');
