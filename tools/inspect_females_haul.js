...
const femaleHaul = [
    'human_female_haul_12_raw.png',
    'human_female_var2_pro_4d_haul.png',
    'human_female_var3_pro_4d_haul.png',
    'human_female_var4_pro_4d_haul.png',
    'human_female_var5_pro_4d_haul.png',
    'human_female_var6_pro_4d_haul.png'
];
...
for (let i = 0; i < femaleHaul.length; i++) {
    const rawPath = path.join('art/raw', femaleHaul[i]);
...
writePNG('game/test_output/all_females_haul_r1.png', w, h, outBuf);
console.log('Saved game/test_output/all_females_haul_r1.png');
