...
const img = decodePNG(fs.readFileSync('art/review/walk_side_combo2.png'));
...
writePNG('art/review/inspect_combo2_4x.png', w, h, buf);
console.log('Saved art/review/inspect_combo2_4x.png');
