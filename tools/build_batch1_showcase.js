...
drawText(35, 24, "GROUP 10: ITEMS & ICONS -- BATCH 1 (3 ITEMS / 6 ASSETS)", [255, 255, 255], 2);
drawText(35, 46, "FF6 HD TOP-DOWN STANDARD  |  FIREWOOD, STONE, IRON ORE  |  ALL CHECKS PASS", [160, 185, 220], 1);
...
for (let idx = 0; idx < ITEMS_DATA.length; idx++) {
    ...
    for (let y = 0; y < 144; y++) {
        for (let x = 0; x < 144; x++) {
            // sample 48x48 at 3x to fit neatly
...
console.log('Saved Batch 1 showcase to:', outPath);
