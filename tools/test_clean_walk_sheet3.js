...
// Using the trio from Row 0: Col 4 (step 1), Col 3 (stand/passing), Col 5 (step 2)
const east0  = extractFrameFromCell(938, 1172, 0, 258, 43); // Row 0 Col 4
const east1  = extractFrameFromCell(704, 938,  0, 258, 43); // Row 0 Col 3
const east2  = extractFrameFromCell(1172, 1408, 0, 258, 43); // Row 0 Col 5
...
writePNG('art/review/pro_walk_12_sheet_perfect.png', 144, 192, testSheet);
console.log('Saved art/review/pro_walk_12_sheet_perfect.png');
