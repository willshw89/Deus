...
// Inspect current $Adam.png
const charDir = path.join(__dirname, '..', 'game', 'img', 'characters');
const adamPath = path.join(charDir, '$Adam.png');
if (fs.existsSync(adamPath)) {
    const buf = fs.readFileSync(adamPath);
    console.log('$Adam.png exists: size =', buf.readUInt32BE(16), 'x', buf.readUInt32BE(20));
}
