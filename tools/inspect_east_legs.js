...
// Let's blow up Row 2 (East) 4x: 3 cols x 48x48 = 144x48 -> 576x192
const w = 144 * 4;
const h = 48 * 4;
...
writePNG('art/review/inspect_east_legs_4x.png', w, h, buf);
console.log('Saved art/review/inspect_east_legs_4x.png');
