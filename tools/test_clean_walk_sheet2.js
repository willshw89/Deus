...
function isMagenta(r, g, b) {
    // Magenta background in this image is around [203, 53, 187]
    // Any pixel where red and blue dominate over green is magenta background or fringed magenta
...
// Clean extraction using tight interior box and isMagenta
function extractFrameFromCell(minX, maxX, minY, maxY, targetH = 43) {
    // Shave 15px inside to avoid black grid lines completely
...
const south0 = extractFrameFromCell(0, 234, 0, 258, 43);
const south1 = extractFrameFromCell(234, 470, 0, 258, 43);
const south2 = extractFrameFromCell(470, 704, 0, 258, 43);

const east0  = extractFrameFromCell(938, 1172, 0, 258, 43);
const east1  = extractFrameFromCell(0, 234, 258, 511, 43);
const east2  = extractFrameFromCell(1172, 1408, 0, 258, 43);

const north0 = extractFrameFromCell(0, 234, 511, 767, 43);
const north1 = extractFrameFromCell(470, 704, 511, 767, 43);
const north2 = extractFrameFromCell(234, 470, 511, 767, 43);
...
writePNG('art/review/pro_walk_12_sheet_clean.png', 144, 192, testSheet);
console.log('Saved art/review/pro_walk_12_sheet_clean.png');
