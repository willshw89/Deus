...
// For each male file, let's extract all 6 cells of Row 1 and assemble a strip
const scale = 2;
const w = 6 * 48 * scale;
const h = 6 * 48 * scale;
...
writePNG('game/test_output/all_males_row1_cells.png', w, h, outBuf);
console.log('Saved game/test_output/all_males_row1_cells.png');
