//=============================================================================
// UF_Fire.js - Fire as a cell state that spreads, burns objects out, hurts units and is put out with water
//=============================================================================

/*:
 * @target MZ
 * @plugindesc [UF Fire] Fire as a spreading cell state: flammability per catalog rule, burn-out results, flames drawn in code, units hurt and fleeing, water-carrying douse jobs.
 * @author UF project
 * @base UF_World
...
(() => {
    ...
    function beat() {
        ...
        const catches = new Map(); // key -> { area, x, y, cause }
        const outs = [];
    ...
    const Fire = {
        ...
        /** Every burning cell: [{ key, area, x, y, since, fuel, obj }]. */
        burningCells() {
            const f = fireState();
            if (!f) return [];
