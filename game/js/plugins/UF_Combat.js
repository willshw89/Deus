//=============================================================================
// UF_Combat.js - Real-time combat on the map in ticks (VISION V64)
//=============================================================================

/*:
 * @target MZ
 * @plugindesc [UF Combat] Real-time combat on the map in ticks: accuracy and defence rolls, max hits, attack speeds, combat styles, attack modes, hitsplats and health bars.
 * @author UF project
 * @base UF_World
 * @orderAfter UF_Items
