//=============================================================================
// DEUS_Jobs.js - Jobs: the only way a unit changes the world (walk there, work, then apply)
//=============================================================================
...
(() => {
    ...
    function registerChecks() {
        UF.Test.suite("jobs", async t => {
            ...
            const okWorkplace = cook.state === "travel" ? !!cook.stand : (cook.state === "failed" && cook.reason === "needs a fire");
            t.check("craft_needs_workplace", okWorkplace,
