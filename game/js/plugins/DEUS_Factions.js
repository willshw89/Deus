//=============================================================================
// DEUS_Factions.js - Factions rolled from the world seed on every New Game
//=============================================================================
...
(() => {
    ...
    const skinParams = (PluginManager.parameters("DEUS_Factions") && Object.keys(PluginManager.parameters("DEUS_Factions")).length ? PluginManager.parameters("DEUS_Factions") : PluginManager.parameters("UF_Factions")) || {};
