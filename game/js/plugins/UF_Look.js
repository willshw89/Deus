//=============================================================================
// UF_Look.js - A cursor tooltip: what is under the mouse, the land it stands on, the art it uses
//=============================================================================

/*:
 * @target MZ
 * @plugindesc [UF Look] Small tooltip next to the cursor: what's on the cell (unit, items, object, site), its biome/region/ground, and the art file with its status. UF.Look, UF.Assets.
 * @author UF project
 * @base UF_World
