//=============================================================================
// UF_Levels.js - Five persistent levels (+2 to -2): cell shapes, one map per level, switching the view
//=============================================================================

/*:
 * @target MZ
 * @plugindesc [UF Levels] Five persistent levels (+2 to -2): seeded level shapes, one map per level, view switching (< > Home) with a level plate, save migration. Vertical slice 1 (VISION V80).
 * @author UF project
 * @base UF_World
 * @orderAfter UF_World
...
(() => {
    ...
    const DEFAULT_LOOK = Object.freeze({
        ...
        open_air: { sheet: "Outside_A5", slot: "A5", tile: 19, tint: "#6f8fb8" },
    ...
    function looksOfPacked(p, z, biomeInfo) {
        ...
        if (s === SOLID) base = m === SOIL ? "soil" : "rock";
        else if (s === OPEN) {
            if (z > 0) base = "open_air";
            else { base = "cave_floor"; l1 = "hole_edge"; }
        } else {
