//=============================================================================
// DEUS_Fog.js - Fog of war, explored by your faction's members
//=============================================================================
...
(() => {
    ...
    const P = (PluginManager.parameters("DEUS_Fog") && Object.keys(PluginManager.parameters("DEUS_Fog")).length ? PluginManager.parameters("DEUS_Fog") : PluginManager.parameters("UF_Fog"));
